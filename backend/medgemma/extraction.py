...
def build_summary_prompt(notes: str = "") -> str:
    ...
    return (
        ...
        "- Do NOT output more than 3 recommendations.\n"
        "- Do NOT use generic filler text like 'Consider further testing' repeatedly.\n"
        "- Keep the total response under 250 words.\n"
        "- Stop generating after the recommendations.\n"
        "\n"
        "### OUTPUT FORMAT ###\n"
