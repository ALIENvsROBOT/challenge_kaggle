...
def build_summary_prompt(notes: str = "", modality: str = "LAB") -> str:
    ...
    common_ending = (
        ...
        "- **Use Markdown ONLY**.\n"
        "- Use `##` for headers.\n"
        "- Use `**bold**` for all numerical values and abnormal findings (High/Low).\n"
        "- **Use '-' for bulleted recommendation lists** (Do not use numbered lists).\n"
        "- Do NOT include any filler text or 'Here is your summary'.\n"
        "\n\n\n"
        "### GOLDEN TEMPLATE (FOLLOW EXACTLY) ###\n\n"
        "## Synthesized Summary\n\n"
        "<Cohesive paragraph with **BOLD** values>\n\n\n"
        "## Key Recommendations\n\n"
